...
<!--               <li class="active">Data</li>-->
           ...
           <div class="search-wrap" style="margin-left: 5px">
               <div class="search-content">
                   <form action="${pageContext.request.contextPath }/manage/growQuery" method="post" name="queryForm">
...
<%--    <td style="line-height: 50px;" ><fmt:formatDate value="${grow.time}" type="date"/>--%>
        <td  style="line-height: 50px;" >
            <button style="padding:2px 6px;" type="button" class="btn btn-sm btn-primary"><a style="text-decoration: none;color: white;" class="updateNo" href="${pageContext.request.contextPath}/manage/growUpdate?id=${grow.id}" ><i class="fa fa-search-minus " aria-hidden="true"></i></a></button>
        </td>
    </tr>
</c:forEach>
    </tbody>
