			...
			<div class="xs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/comment/updateexe">
							<input type="hidden"  name="id" value="${comment.id}"/>

							<div class="form-group">
								<label  class="col-sm-2 control-label">问卷调查</label>
							...
							<div class="form-group">
								<label  class="col-sm-2 control-label">评价意见</label>
								<textarea  class="common-textarea" id="reply" name="reply" value="${comment.reply}" style="margin-left: 16px;width: 64%;" cols="30"  rows="10"></textarea>
<%--								style="margin-left: 15px;width: 814px;"--%>
<%--								<div class="col-sm-8"  id="editor1">--%>
