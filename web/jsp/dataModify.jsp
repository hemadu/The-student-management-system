						...
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/data/updateexe">
							...
							<div class="form-group">
								<div class="btns" style="margin-left: 232px;">
									...
									<img src="${pageContext.request.contextPath}/images/${data.pic}" id="show" style="max-width:40px;margin-left: 30px;margin-bottom: 10px;"/>
								</div>
								<input  type="hidden" class="common-text required" id="img"  name="pic" value="${data.pic}">
							</div>

							<div class="form-group">
								<label  class="col-sm-2 control-label">名称</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="name"  value="${data.name}">
								</div>
							</div>
							<div class="form-group">
								<label  class="col-sm-2 control-label">成绩</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="score"  value="${data.score}">
								</div>
							</div>
							<div class="form-group">
