			...
			<div class="xs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form id="userForm" class="form-horizontal" name="userForm" method="post" action="${pageContext.request.contextPath }/grow/add">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="type" class="form-control1"  >
										<option value="个人作品展示" selected class="form-control1">个人作品展示</option>
										<option value="日记" class="form-control1">日记</option>
										<option value="成长相册" class="form-control1">成长相册</option>
										<option value="第一次" class="form-control1">第一次</option>
										<option value="实践活动" class="form-control1">实践活动</option>
										<option value="纪念日" class="form-control1">纪念日</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="date" placeholder="yyyy-MM-dd" class="form-control1" name="date">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<div class="checkbox-inline"><label><input type="radio"  name="role"  value="1" checked>私密
									</label></div>
								</div>
							</div>
							<div class="form-group">
